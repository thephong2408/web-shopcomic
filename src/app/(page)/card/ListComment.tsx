...
export default function ListComment() {
  ...
  return (
    <div className="lg:w-[775px] w-full relative flex flex-col my-10 bg-[#1f1f1f] lg:p-[30px] p-[15px] rounded-xl">
      {/* comment */}
      <div className="w-[100%] flex justify-between items-center">
        {/* avatar */}
        <ImCool2 className="text-40" />
        {/* input */}
        <div className="flex-1 ml-3 lg:h-[45px] h-[35px] rounded-xl bg-[#343434] flex items-center justify-between px-5">
          {" "}
      ...
      {/* list comment */}
      <div className="relative max-h-[800px] min-h-[200px] overflow-y-auto mt-[30px] lg:px-[30px] px-[15px]">
        {arr.length === 0 && (
            ...
            {arr.slice(0, 1).map((item: any, index: number) => (
              <li key={index} className="text-18  flex justify-between">
                ...
                <div className="flex-1">
                  <div className="w-full  ml-3 bg-[#4b4b4b] rounded-lg p-5 text-16">
                    <span className="font-bold">Name</span>
                    <p>comment</p>
                  </div>
                  <div className="text-14 space-y-[20px]">
